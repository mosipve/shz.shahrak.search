...
if (mysqli_num_rows($result) > 0) {
		...
		echo "<ul class=\"colitemx\">
			...
			<hr>
			<li><b>موارد یافت شده </b> : $search</li>";
		echo "</ul>";
	 ...
	 echo '<div id="printableArea">';
		 ...
		 */
			...
			echo "</dl>";				
				...
				//echo " <input type=\"button\" class=\"mybutt\" value=\"چاپ اطلاعات\" onclick=\"JavaScript:printPartOfPage('$momopipi');\" /> ";
				
				echo '</ul>';	
		echo '</div>';
		/* echo " <input type=\"button\" class=\"mybutt\" value=\"Print\" onclick=\"JavaScript:printPartOfPage('$momopipi');\" /> "; */
	  echo '</div>';
		echo '<input type="button" onclick="printDiv(\'printableArea\')" value="print a div!" />';
    }
} else {
    echo "<br />";
